  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Our Branches</h6>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table action-panel table-bordered" id="dataTable" cellspacing="0">
                ...
                <tbody>
                <c:forEach items = "${branch}" var = "ex">
                <tr>
                  <td>${ex.id}</td>
                  <td>${ex.name}</td>
                  <td>${ex.address}</td>
                  <td><a href='<c:url value = "/editBranch/${ex.id}"/>'
      ...
      <div class="card-header py-3">
        ...
        <a href='<c:url value = "/addBranch"/>' class="btn btn-info btn-icon-split">
